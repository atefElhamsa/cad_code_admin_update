...
class UploadTaskDialog extends StatefulWidget {
  final int folderId;
  const UploadTaskDialog({super.key, required this.folderId});
        ...
        child: Column(
          ...
          children: [
            ...
            TextField(
              ...
              decoration: customInputDecoration('Task Title'),
            ),
            const SizedBox(height: 16),
            TextField(
              controller: _descController,
              decoration: customInputDecoration('Description (Optional)'),
              maxLines: 2,
            ),
                ...
                ElevatedButton(
                  onPressed: () {
                    if (_titleController.text.isNotEmpty &&
                        _selectedFile != null) {
                      context.read<TasksCubit>().uploadTask(
                        _selectedFile!.path,
